{
    ...
    'data': [
        ...
        'data/speedrun_loot_sequence_data.xml',
        'data/speedrun_matchmaking_cron.xml',
        'data/speedrun_cleanup_cron.xml',
        'data/speedrun_clan_cron.xml',
